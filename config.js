const config = {
  property: {
    ...
    heroSubtitle:
      "Quiet and safe neighbourhood with proximity to Etienne Brule Park and the Humber River Trail. Spacious 44x146-foot lot, functional layout, and strong foundation. Register to receive the complete Home & Neighbourhood Info Package, virtual tour, floor plans, and comparables.",
    backgroundImageUrl:
      "https://api.typeform.com/responses/files/be4df8285c681cdec0c4678f656fe6a221f976356bdd1d98d31b211ade765152/2_second_photo.jpg",
  },
  realtor: {
    fullName: "James Hall",
    title: "REALTOR®",
  ...
  openHouse: {
    ...
    bundleItems: [
      {
        icon: "fas fa-link",
        text: "Property Listing URL: https://property.ca/toronto/14-warren-crescent-york?ref_code=tumwncsa",
      },
      {
        icon: "fas fa-ruler-combined",
        text: "Floor Plan: file:///Users/jameshall/Downloads/14%20Warren%20Crescent,%20York,%20ON%20M6S%204S2,%20Canada%204.pdf",
      },
      {
        icon: "fas fa-image",
        text: "Photos",
      ...
      {
        icon: "fas fa-video",
        text: "Virtual Tour: https://my.matterport.com/show/?m=15dANrbnauz",
      },
      {
        icon: "fas fa-chart-bar",
        text: "On-Market Comparables: https://app.realmmlp.ca/shared/Nl56BY9Wp6tgp7oeb4W5/nyGPnEMOGAI5Zo7J27jGC1VQa42jMnhEWLZb3yKOtDqYGD99qJHPrB96ok7PuqX2rkgoOlCDjbZRLkqGCZnaropk6wc5jJX33Vlyu31AEREn1EC56wnDnX6nHeL6by59ywSGeqYVlAN8fPEP5A9",
      },
    ],
  },
  meta: {
